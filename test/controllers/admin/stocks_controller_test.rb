...
class Admin::StocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_stock" do
    assert_difference("Admin::Stock.count") do
      post admin_stocks_url, params: { admin_stock: { name: @admin_stock.name, product_id: @admin_stock.product_id, value: @admin_stock.value } }
    end
  ...
  test "should update admin_stock" do
    patch admin_stock_url(@admin_stock), params: { admin_stock: { name: @admin_stock.name, product_id: @admin_stock.product_id, value: @admin_stock.value } }
